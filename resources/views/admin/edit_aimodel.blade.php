<x-layout>
    ...
    <form method="POST" action="/aimodels/{{$aimodel->id}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-6">
            <label
        ...
        <div class="mb-6">
            ...
            <a href="/admin/aimodel" class="text-white ml-4"> Back </a>
        </div>
    </form>
    </x-card>
    </x-layout>