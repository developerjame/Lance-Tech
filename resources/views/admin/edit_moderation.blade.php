<x-layout>
    ...
    <form method="POST" action="/moderations/{{$moderation->id}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-6">
            <label
            ...
            <input
                ...
                name="name" value="{{$moderation->name}}"
            />
            @error('name')
        ...
        <div class="mb-6">
            ...
            <textarea
                ...
                rows="10"
                placeholder=""
            >{{$moderation->description}}</textarea>
            @error('description')
               <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <a href="/admin/moderation" class="text-white ml-4"> Back </a>
        </div>
    </form>
    </x-card>
    </x-layout>