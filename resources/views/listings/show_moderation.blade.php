<x-layout>
    @auth
    <a href="/admin/moderation" class="inline-block text-white ml-4 mb-4"
    ...
    <x-card class="p-10">
        ...
        >
            ...
            <h1 class="text-3xl text-white mb-2">{{$moderation->name}}</h1>
            <div class="text-xl text-white font-bold mb-4"><p>Price: ${{$moderation->price}}</p></div>
            ...
            <div>
                ...
                <div class="text-lg text-white space-y-6">
                    ...
                    <a
                                id="edit"
                                href="/accounts/{{$moderation->id}}/edit"
